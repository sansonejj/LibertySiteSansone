...
<div class="body">
    <table border="1" align="center">
        ...
        <tr>
            ...
            <td><?php echo $_POST['item1rating']; ?></td>
            <td><?php echo $_POST['item2rating']; ?></td>
            <td><?php echo $_POST['item3rating']; ?></td>
        </tr>

        <tr>
            <td>Comments:</td>
            <td><?php echo $_POST['item1comments']; ?></td>
            <td><?php echo $_POST['item2comments']; ?></td>
            <td><?php echo $_POST['item3comments']; ?></td>
        </tr>
    </table>
</div>
