...
$urls = array("index.php","w1_AboutUs.php", "w1_phpInfo.php", "w1_contactUs.php", "w1_orgchart.php",
    "Week 5/product_purchase.php", "Week 5/cart.php", "Week 5/newsletter_signup.php", "Week 5/testimonials.php", "/week2/w2_webpoll_get.php", "Week 5/facts.php", "Week 5/our_goals.php",
    "Week 5/more_info.php", "Week 5/news.php", "Week 5/our_mission.php", "Week 5/resources.php");
