...
$product4_description = 'Introducing the Axon body-cam, a sleek body camera.
Wear it effortlessly to capture every crucial moment with high-quality audio and video.';
$product4_photo = 'images/4_axon_bodycam.jpg';
$product4_price = 3995.00;

//Product 5
$product5_name = 'Axon Fleet Dash-cam';
$product5_description = 'Introducing the Axon Dash-cam, a powerful ally for law enforcement. 
...
it is the ultimate tool for accountability and evidence gathering.';
...
Introducing the Dell Latitude mobile solution for Police, Fire, and EMS – a cutting-edge solution for first responders. 
This powerful device ensures seamless communication and information access on the go. With robust features tailored for
law enforcement, firefighters, and emergency medical services, it is the ultimate tool for real-time data and 
coordination.';
...
coordination. This device provides flexibility, giving users the ability to detach the screen and operate it outside
 of their vehicle.';
